...
namespace Library12
{
    public class ReaderTemparary : Reader
    {
        public DateTime AccessDate;
        public List<string> Sections;

        public ReaderTemparary (string name, string surname, int number, DateTime access, List<string> sections) : base(name, surname, number)
        {
            AccessDate = access;
            Sections = sections;
        }
